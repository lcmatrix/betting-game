...
import de.bettinggame.application.game.GameTO;
...
public class GameController implements AbstractController {
    ...
    public ModelAndView list() {
        ...
        Map<TournamentLevel, List<GameTO>> matchesByLevel = games.stream()
                .collect(Collectors.groupingBy(Game::getLevel, TreeMap::new,
                        Collectors.mapping(GameTO::new, Collectors.toList())));
